...
D - Divide");
        ...
        try
        {
            var result = calculator.DoOperation(cleanNumber1, cleanNumber2, op);
    ...
    public void SecondRun(Calculator calculator)
    {
        Console.Clear();
        Console.WriteLine("Console Calculator in C#\r");
        Console.WriteLine("------------------------\n");
        ...
        var secondRunEngaged = true;

        while (secondRunEngaged)
        {
            Console.Clear();
            Console.WriteLine("Console Calculator in C#\r");
            Console.WriteLine("------------------------\n");
